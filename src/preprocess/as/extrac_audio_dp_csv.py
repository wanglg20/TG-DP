...
if __name__ == '__main__':
    ...
    parser.add_argument("-input_file_list", type=str, default='/data/wanglinge/project/weighted-cav-mae/src/data_info/as2M/audioset_20k_cleaned_converted.json', help="CSV file: one video path per line")
    parser.add_argument("-target_fold", type=str, default='/data/wanglinge/dataset/AudioSet20k/audio', help="Folder to store output audio")
