...
parser.add_argument("-input_file_list", type=str, default='/data/wanglinge/project/weighted-cav-mae/src/data_info/as2M/eval.csv', help="Should be a csv file of a single columns, each row is the input video path.")
parser.add_argument("-target_fold", type=str, default='/data/wanglinge/dataset/AudioSet2M/audio', help="The place to store the video frames.")
args = parser.parse_args()

df = pd.read_csv(args.input_file_list)
input_filelist = df['video_path'].values
